<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TransactionPage.aspx.cs" Inherits="ProFootball.View.TransactionPage" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="UsrFormContent">
            ...
            <asp:TextBox ID="qtyTxt" runat="server" style="width:72%"></asp:TextBox>
            <br /><br />
