...
{
    public partial class ViewPlayerPosition : System.Web.UI.Page
    {
        static User usr;

        protected void Page_Load(object sender, EventArgs e)
        {
            List<PlayerPosition> playerPos = PlayerPositionController.ViewPlayerPosition();
            Repeater1.DataSource = playerPos;
            Repeater1.DataBind();
