<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UpdateUser.aspx.cs" Inherits="ProFootball.View.UpdateUser" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="UsrFormContent">
            ...
            <asp:TextBox ID="FnameTxt" runat="server" placeHolder="Luke" style="width:68%"></asp:TextBox>
            <br /><br />

            <asp:Label ID="Label3" runat="server" Text="Lastname: "></asp:Label>
            <asp:TextBox ID="LnameTxt" runat="server" placeHolder="McKeon" style="width:69%"></asp:TextBox>
            <br /><br />

            <asp:Label ID="Label5" runat="server" Text="Date of Birth: "></asp:Label>
            <asp:TextBox ID="dobTxt" runat="server" placeHolder="dd/mm/yyy" style="width:61%"></asp:TextBox>
            <br /><br />
