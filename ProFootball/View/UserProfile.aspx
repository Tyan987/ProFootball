<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserProfile.aspx.cs" Inherits="ProFootball.View.UpdateUserByUser" %>
        ...
        <div class="UsrFormContent">
            ...
            <asp:Repeater ID="Repeater1" runat="server">
                <ItemTemplate>
                    ...
                    <asp:Label ID="emailTxt" runat="server" Text='<%# Eval("Email") %>'></asp:Label>
                    <br /><br /> 

                    <asp:Label ID="Label2" runat="server" Text="Firstname: "></asp:Label>
                    <asp:Label ID="FnameTxt" runat="server" Text='<%# Eval("Firstname") %>'></asp:Label>
                    <br /><br />

                    <asp:Label ID="Label3" runat="server" Text="Lastname: "></asp:Label>
                    <asp:Label ID="LnameTxt" runat="server" Text='<%# Eval("Lastname") %>'></asp:Label>
                    <br /><br />

                    <asp:Label ID="Label5" runat="server" Text="Date of Birth: "></asp:Label>
                    <asp:Label ID="dobTxt" runat="server" Text='<%# Eval("DOB") %>'></asp:Label>
                    <br /><br />

                    <div class="profileBtn">
                        <a href="UpdateUser.aspx?email=<%#Eval("Email") %>">Update</a>
                        <a href="DeleteUser.aspx?email=<%#Eval("Email") %>">Delete</a>
                    </div>
                </ItemTemplate>
            </asp:Repeater>
        </div>
