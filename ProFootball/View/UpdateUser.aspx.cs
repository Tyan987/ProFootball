...
namespace ProFootball.View
{
    public partial class UpdateUser : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                usr = UserController.FindByEmail(Request.QueryString["Email"]);
                ...
                {
                    emailTxt.Text = usr.Email;
                    FnameTxt.Text = usr.Firstname;
                    LnameTxt.Text = usr.Lastname;
                    dobTxt.Text = usr.DOB.ToString();
                }
            }
        ...
        protected void updateBtn_Click(object sender, EventArgs e)
        {
            ...
            msg = UserController.UpdateUser(email, Fname, Lname, password, DOB);

            if (msg.Equals(""))
            {
                LblMsg.Text = "Update User Successfully! ";
            }
            else
            {
                LblMsg.Text = msg;
