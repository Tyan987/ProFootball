<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PlayerMarket.aspx.cs" Inherits="ProFootball.View.PlayerMarket" %>
            ...
            <asp:Repeater ID="Repeater1" runat="server">
                <ItemTemplate>
                    <tr>
                        ...
                        <td><a href="TransactionPage.aspx?id=<%# Eval("PlayerID") %>">Buy</a></td>
                    </tr>               
                </ItemTemplate>
            </asp:Repeater>
            </table>
